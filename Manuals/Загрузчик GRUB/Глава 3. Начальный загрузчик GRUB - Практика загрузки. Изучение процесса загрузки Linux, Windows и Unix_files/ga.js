...
'	 <li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/NetworkProtocolsForSecurityProfessionals/content/index.html" target="_top">Сетевые протоколы для профессионалов безопасности</a>, Йорам Орзач, Дипаншу Ханна, Packt Publishing, октябрь 2022</p>'+
'	 <li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/JavascriptHackersLearnThink/content/index.html" target="_top">JavaScript для хакеров. Научитесь думать как хакер</a>, Гарет Хейс, Leanpub, декабрь 2022</p>'+
'	 <li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/HowToHackLikeLegend/content/index.html" target="_top">Как заниматься взломом словно легенда. Прорываемся в Windows</a>, Спарк Флоу, No Starch Press, октябрь 2022</p>'+
'	 <li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/MainMemoryManagementDatabase/content/index.html" target="_top">Управление оперативной памятью в реляционных системах баз данных</a>, Педро Мехия Альварес, Марсело Леон Айяла, Сусана Ортега Сиснерос, Springer, август 2022</p>'+
...
'	 <p><a class="link" href="http://onreader.mdl.ru/MainMemoryManagementDatabase/content/index.html" target="_top">Управление оперативной памятью в реляционных системах баз данных</a>, Педро Мехия Альварес, Марсело Леон Айяла, Сусана Ортега Сиснерос, Springer, август 2022</p>'+
'	 </li><li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/OffensiveShellcodeScratch/content/index.html" target="_top">Атакующий код запуска оболочки с нуля</a>, Ришалин Пиллэй, Packt Publishing, май 2022</p>'+
'	 </li><li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/ProWindowsSubsystemLinux/content/index.html" target="_top">Linux подсистема Windows (WSL) для профессионалов</a>, Хайден Барнс, Apress, июнь 2021</p>'+
'	 </li><li class="listitem">'+
...
'	 </li><li class="listitem">'+
'	 <p><a class="link" href="http://onreader.mdl.ru/DistributedSystemsForPractitioners/content/Ch07.html" target="_top">Распределённые системы для практиков</a>, Даймос Раптис, Leanpub, май 2020</p>'+
'	 </li><li class="listitem">'+
